                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="form-group">
                            ...
                            <input className="form-control" id="phone" name="phone" placeholder="+968 7272 0046" type="text" required autoComplete='off' dir="ltr" />
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-lg-6">
                        <div className="form-group">
                            ...
                            <input className="form-control" id="email" name="email" placeholder="info@zainom.com" type="email" required autoComplete='off' />
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="form-group">
