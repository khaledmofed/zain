  ...
  return (
    <>
      <header className="adjust-height">
        <nav
          className={`navbar mobile-sidenav navbar-theme-secodnary navbar-common navbar-sticky navbar-default validnavs on no-full ${isMenuSticky ? "sticked" : ""} ${isOpen ? "navbar-responsive" : ""} ${isInfoOpen ? "pause-sticked" : ""} ${openSearch ? "pause-sticked" : ""}`}
        >
