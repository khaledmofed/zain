...
const MainHeaderStyle5 = () => {
  ...
  return (
    <>
      <header>
        <nav
          className={`navbar mobile-sidenav navbar-style-three navbar-sticky navbar-default validnavs navbar-fixed white on no-full ${isMenuSticky ? "sticked" : "no-background"} ${isOpen ? "navbar-responsive" : ""}`}
        >
