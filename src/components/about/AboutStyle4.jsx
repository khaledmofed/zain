        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 about-style-four">
              ...
              <h2 className="title">
                Creating a better future <br /> for your loved once
              </h2>
              <div className="thumb mt-50 mt-xs-30">
                ...
                <Animate className="animate__animated animate__fadeInUp">
                  <div className="experience">
                    <h2>
                      <strong>1988</strong> Year of establishment
                    </h2>
                  </div>
                </Animate>
              </div>
            ...
            <div className="col-lg-5 offset-lg-1 about-style-four">
              ...
              <p>
                ...
                parties but why she shewing. She sang know now get joy you
                ...
                <Animate className="animate__animated animate__fadeInUp">
                  <div className="list-item-style-two">
                    ...
                    <div className="info">
                      ...
                      <p>
                        Facilisis leo vel fringilla est ullamcorper. Posuere
                        urna nec tincidunt praesent semper feugiat nibh sed. Non
                ...
                >
                  <div className="list-item-style-two">
                    ...
                    <div className="info">
                      ...
                      <p>
                        Technical leo vel fringilla est ullamcorper. Posuere
                        urna nec tincidunt praesent semper feugiat nibh sed. Non
