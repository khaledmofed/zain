...
const SingleBanner1 = ({ banner }) => {
    ...
    return (
        <>
            <div className="banner-thumb bg-cover shadow dark" style={{ background: `url(/assets/img/banner/${imagePath})` }}></div>
            <div className="container">
                <div className="row align-center">
                    <div className="col-xl-7 offset-xl-5">
                        <div className="content">
                            <h4>{bannerTitle}</h4>
                            <h2><strong>{bannerTitle1}</strong> {bannerTitle2}</h2>
                            <div className="button mt-40">
                                <Link className="btn-animation" href="/about-us"><i className="fas fa-arrow-right"></i> <span>{t('aboutButton')}</span></Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="banner-shape-bg">
                <Image src={`/assets/img/shape/${shapeThumb}`} width={916} height={693} alt="Shape" className="toty-logo" />
            </div>
        </>
    );
};
